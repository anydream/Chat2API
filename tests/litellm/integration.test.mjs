...
test('bundled LiteLLM configuration keeps client probe and protocol bridge configurable', () => {
  ...
  assert.match(serverCompose, /CHAT2API_QWEN_AI_CHAT_IN_PROGRESS_RETRY_ATTEMPTS:\s*\$\{CHAT2API_QWEN_AI_CHAT_IN_PROGRESS_RETRY_ATTEMPTS:-3\}/)
  ...
  assert.match(serverDockerfile, /ENV CHAT2API_QWEN_AI_CHAT_IN_PROGRESS_RETRY_ATTEMPTS=3/)
